...
export default function OklahomaSenatePrimariesPage() {
  const democraticCandidates = [
    {
      name: "N’Kiyla “Jasmine” Thomas (D)",
      image: "thomas.png",
      bio: "Community organizer and advocate for education, equity, and justice reform.",
      ideology: "Progressive Democrat",
      endorsements: ["Oklahoma Educators United"],
      sliders: ["75%", "85%", "60%", "40%"]
    }
  ];

  const republicanCandidates = []; // No declared candidates yet

  const potentialContenders = [
    { name: "Stephanie Bice (R)", image: "brice.jpg" },
    { name: "Markwayne Mullin (R)", image: "mullin.jpg" },
    { name: "Matt Pinnell (R)", image: "pinnell.jpg" },
    { name: "Kevin Stitt (R)", image: "stitt.jpg" },
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Oklahoma U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming soon) polling trends for Oklahoma’s 2026 U.S. Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Oklahoma uses a closed primary system. Voters must be registered party members to participate in their party's primary.
        </p>
      </div>
