...
export default function RhodeIslandSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Jack Reed (D)",
      image: "reed.jpg",
      bio: "Incumbent U.S. Senator since 1997, known for leadership on defense and veterans’ issues.",
      ideology: "Moderate Democrat",
      endorsements: ["Rhode Island Democratic Party"],
      sliders: ["55%", "60%", "50%", "65%"],
    },
    {
      name: "Connor Burbridge (D)",
      image: "burbridge.jpg",
      bio: "Elder care worker focused on healthcare access and aging populations.",
  ...
  const potentialContenders = []; // none yet
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Rhode Island U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological profiles, and early projections in Rhode Island’s Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Rhode Island uses a closed primary system. Only registered party members may vote in their party’s primary.
        </p>
      </div>
