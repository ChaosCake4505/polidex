...
export default function KentuckySenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Pamela Stevenson (D)",
      image: "stevenson.jpg",
      bio: "Minority Leader of the Kentucky House and 2023 attorney general nominee focused on justice reform and voting rights.",
      ideology: "Progressive Democrat",
      endorsements: ["Kentucky Equality PAC"],
      sliders: ["75%", "80%", "60%", "55%"],
    },
  ];
  ...
  const republicanCandidates = [
    {
      name: "Andy Barr (R)",
      image: "barr.jpg",
      bio: "U.S. Representative since 2013 emphasizing fiscal responsibility and constituent services.",
      ideology: "Mainstream Conservative",
      endorsements: [],
      sliders: ["65%", "70%", "50%", "60%"],
    },
    {
      name: "Daniel Cameron (R)",
      image: "cameron.jpg",
      bio: "Former Attorney General and 2023 gubernatorial nominee with a law-and-order record.",
      ideology: "Establishment Conservative",
      endorsements: [],
      sliders: ["70%", "75%", "60%", "70%"],
    },
    {
      name: "Michael Faris (R)",
      image: "faris.jpeg",
      bio: "Helicopter maintenance business owner campaigning on infrastructure and small business issues.",
    ...
    },
    {
      name: "Nate Morris (R)",
      image: "morris.jpg",
      bio: "Business conglomerate owner focusing on economic growth and innovation.",
      ideology: "Entrepreneurial Conservative",
      endorsements: [],
      sliders: ["70%", "75%", "60%", "65%"],
    },
  ];

  const potentialContenders = []; // Add names here later if needed
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Kentucky U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates and ideological profiles for Kentucky’s 2026 Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Kentucky uses a closed primary system; only registered party members can vote in their party’s primary.
        </p>
      </div>
