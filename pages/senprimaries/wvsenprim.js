...
export default function WestVirginiaSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Zach Shrewsbury (D)",
      image: "shrewsbury.png",
      bio: "Political organizer, U.S. Marine Corps veteran, and progressive candidate for Senate in 2024.",
  ...
  const republicanCandidates = [
    {
      name: "Alex Gaaserud (R)",
      image: "gaaserud.png",
      bio: "Third-party logistics executive and former candidate for West Virginia’s 2nd congressional district in 2024.",
    ...
    },
    {
      name: "Tom Willis (R)",
      image: "willis.jpg",
      bio: "State senator for West Virginia’s 15th district and prior U.S. Senate candidate in 2018.",
  ...
  const potentialContenders = [{ name: "Shelley Moore Capito (R)", image: "capito.jpg" }];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          West Virginia U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological profiles, and possible contenders in West Virginia’s Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * West Virginia uses a semi-closed primary system. Unaffiliated voters may choose a party ballot to vote in a primary.
        </p>
      </div>
