...
export default function OhioSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Sherrod Brown (D)",
      image: "sbrown.jpg",
      bio: "Incumbent U.S. Senator known for pro-labor populism, manufacturing policy, and consumer protection.",
      ideology: "Progressive Populist",
      endorsements: ["Ohio AFL-CIO", "Labor Councils"],
      sliders: ["70%", "85%", "65%", "45%"],
    },
    {
      name: "Lynnea Lau (D)",
      image: "lau.png",
      bio: "Medical research compliance officer focused on science-based policy and public health.",
      ideology: "Centrist Democrat",
      endorsements: ["Ohio Health Science Union"],
      sliders: ["60%", "80%", "45%", "50%"],
    },
    {
      name: "Chris Volpe (D)",
      image: "volpe.jpg",
      bio: "Computer game company founder advocating for innovation and small business support.",
      ideology: "Progressive Entrepreneur",
      endorsements: ["Ohio Startup Alliance"],
      sliders: ["65%", "70%", "55%", "45%"],
    },
  ];
  ...
  const republicanCandidates = [
    {
      name: "Jon Husted (R)",
      image: "husted.jpg",
      bio: "Lieutenant Governor of Ohio and former Secretary of State, focusing on economic development.",
      ideology: "Mainstream Conservative",
      endorsements: ["Ohio GOP Leadership", "Business Roundtable"],
      sliders: ["70%", "60%", "40%", "55%"],
    },
  ];

  const potentialContenders = [
    { name: "Casey Weinstein (D)", image: "weinstein.jpg" },
    { name: "Allison Russo (D)", image: "russo.jpg" },
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Ohio U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming soon) polling trends for Ohio’s 2026 U.S. Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Ohio uses a closed primary system. Only registered party members may vote in their party’s primary.
        </p>
      </div>
