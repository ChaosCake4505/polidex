...
export default function MinnesotaSenatePrimariesPage() {
  const democraticCandidates = [
    {
      name: "Angie Craig (D)",
      image: "craig.jpg",
      bio: "U.S. Representative for Minnesota’s 2nd district known for healthcare access and infrastructure advocacy.",
      ideology: "Moderate Democrat",
      endorsements: ["Minnesota DFL", "Labor Unions"],
      sliders: ["55%", "65%", "50%", "45%"],
    },
    {
      name: "Peggy Flanagan (D)",
      image: "flanagan.jpg",
      bio: "Lieutenant Governor of Minnesota and former state legislator focused on tribal rights and social equity.",
      ideology: "Progressive Democrat",
      endorsements: ["Minnesota DFL", "Indigenous Voters Association"],
      sliders: ["70%", "80%", "55%", "50%"],
    },
  ];
  ...
  const republicanCandidates = [
    {
      name: "Adam Schwarze (R)",
      image: "schwarze.jpeg",
      bio: "Former Navy SEAL with a focus on veterans’ issues and national security.",
      ideology: "Veteran Conservative",
      endorsements: ["Veterans for America PAC"],
      sliders: ["80%", "70%", "60%", "70%"],
    },
    {
      name: "Royce White (R)",
      image: "white.jpg",
      bio: "Former NBA player and 2024 Senate nominee advocating for mental health reform.",
      ideology: "Populist Conservative",
      endorsements: ["Mental Health America"],
      sliders: ["60%", "65%", "55%", "50%"],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      {/* Header Section (matches New Mexico style) */}
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Minnesota U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming
          soon) polling trends for Minnesota’s 2026 U.S. Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Minnesota uses a semi-closed primary system. Registered party
          members and unaffiliated voters may choose a party’s primary.
        </p>
      </div>
      ...
      <div className="w-full max-w-6xl mx-auto bg-gray-800/90 rounded-lg p-8 shadow my-12">
        ...
        {democraticCandidates.length === 0 ? (
          <p className="text-center text-white text-lg italic">
            No declared candidates at this time.
          </p>
        ) : (
...
/** Candidate card with circular photo (shared with NM style) */
