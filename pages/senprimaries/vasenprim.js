...
export default function VirginiaSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Mark Warner (D)",
      image: "warner.jpg",
      bio: "Incumbent U.S. Senator since 2009, former Virginia governor and business executive.",
      ideology: "Moderate Democrat",
      endorsements: ["Virginia Democratic Party"],
      sliders: ["60%", "70%", "55%", "65%"],
    },
  ];
  ...
  const republicanCandidates = [
    {
      name: "Kim Farington (R)",
      image: "farington.jpg",
      bio: "Financial accountant focused on fiscal responsibility and small business tax reform.",
  ...
  const potentialContenders = [{ name: "Glenn Youngkin (R)", image: "youngkin.jpg" }];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">Virginia U.S. Senate Primaries</h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological profiles, and possible contenders in Virginia’s Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Virginia uses an open primary system. Registered voters may vote in either party’s primary, but not both.
        </p>
      </div>
