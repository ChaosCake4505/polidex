...
export default function SouthCarolinaSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Annie Andrews (D)",
      image: "andrews.jpg",
      bio: "Pediatrician and 2022 nominee for South Carolina's 1st congressional district.",
      ideology: "Progressive Democrat",
      endorsements: ["Planned Parenthood Action Fund"],
      sliders: ["70%", "65%", "60%", "55%"],
    },
    {
      name: "Brandon Brown (D)",
      image: "bbrown.png",
      bio: "Former VP at Paine College and nominee for SC-4 in 2004 and 2018.",
      ideology: "Mainstream Democrat",
      endorsements: [],
      sliders: ["60%", "55%", "50%", "60%"],
    },
    {
      name: "Catherine Fleming Bruce (D)",
      image: "bruce.jpg",
      bio: "Author and 2022 U.S. Senate candidate.",
      ideology: "Progressive Democrat",
      endorsements: [],
      sliders: ["65%", "60%", "55%", "50%"],
    },
    {
      name: "Kyle Freeman (D)",
      image: "freeman.jpg",
      bio: "Logistics professional with focus on infrastructure and economic growth.",
  ...
  const republicanCandidates = [
    {
      name: "André Bauer (R)",
      image: "bauer.jpg",
      bio: "Former Lieutenant Governor and candidate for Congress and Governor.",
    ...
    },
    {
      name: "Paul Dans (R)",
      image: "dans.jpg",
      bio: "Former OPM Chief of Staff and co-author of Project 2025.",
    ...
    },
    {
      ...
      image: "graham.avif",
      bio: "Incumbent U.S. Senator since 2003.",
      ideology: "Mainstream Conservative",
      endorsements: ["NRA", "Chamber of Commerce"],
      sliders: ["50%", "65%", "60%", "80%"],
    },
    {
      name: "Mark Lynch (R)",
      image: "lynch.jpg",
      bio: "Appliance repair executive running on small business advocacy.",
      ideology: "Libertarian Conservative",
      endorsements: [],
      sliders: ["45%", "50%", "40%", "55%"],
    },
    {
      name: "Thomas Murphy (R)",
      image: "tmurphy.jpg",
      bio: "Retired Navy hospital corpsman focused on veterans' issues.",
  ...
  const potentialContenders = []; // Add names/images here later
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          South Carolina U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological positions, and early polling trends for South Carolina’s partisan primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * South Carolina uses an open primary system. Any registered voter may vote in either party’s primary, but not both.
        </p>
      </div>
