...
export default function GeorgiaSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Jon Ossoff (D)",
      image: "ossoff.jpg",
      bio: "Incumbent U.S. Senator known for his focus on civil rights, healthcare access, and bipartisan economic development.",
      ideology: "Progressive Democrat",
      endorsements: ["Planned Parenthood Action Fund", "Georgia AFL-CIO"],
      sliders: ["70%", "65%", "55%", "45%"],
    },
  ];
  ...
  const republicanCandidates = [
    {
      name: "Reagan Box (R)",
      image: "box.jpg",
      bio: "Horse trainer and conservative activist focused on rural issues and government overreach.",
    ...
    },
    {
      name: "Buddy Carter (R)",
      image: "carter.jpg",
      bio: "U.S. Representative emphasizing tax reform, drug pricing transparency, and veterans' services.",
      ideology: "Mainstream Conservative",
      endorsements: ["Club for Growth", "NRLC"],
      sliders: ["75%", "65%", "60%", "70%"],
    },
    {
      name: "Mike Collins (R)",
      image: "mcollins.webp",
      bio: "U.S. Representative known for pro-business policies, deregulation, and transportation reform.",
      ideology: "Pro-Business Conservative",
      endorsements: ["NFIB", "FreedomWorks"],
      sliders: ["70%", "80%", "60%", "80%"],
    },
      {
      name: "Derek Dooley (R)",
      image: "dooley.webp",
      bio: "Former head coach of the University of Tennessee Football Team.",
  ...
  const potentialContenders = [
    { name: "Colton Moore (R)", image: "cmoore.jpg" },
    { name: "Rick Allen (R)", image: "allen.jpg" },
    { name: "Tyler Harper (R)", image: "harper.jpg" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">Georgia U.S. Senate Primaries</h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological positions, and early polling trends for Georgia’s Senate race.
        </p>
        <p className="text-sm italic text-gray-400">
          * Georgia uses an open primary system. All registered voters may participate in either party’s primary.
        </p>
      </div>
