...
export default function WyomingSenPrimariesPage() {
  ...
  const republicanCandidates = [
    {
      ...
      image: "lummis.jpg",
      bio: "Incumbent U.S. Senator since 2021 and former U.S. Representative, known for her work on cryptocurrency policy and conservative values.",
      ideology: "Conservative Republican",
      endorsements: ["National Rifle Association", "Wyoming Republican Party"],
      sliders: ["90%", "75%", "60%", "65%"]
    }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Wyoming U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming soon) polling trends for Wyoming’s 2026 U.S. Senate primaries.
        </p>
