...
export default function SouthDakotaSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Julian Beaudion (D)",
      image: "beaudion.png",
      bio: "Former police officer and educator running to bring moderate leadership and rural representation to Washington.",
      ideology: "Moderate Democrat",
      endorsements: ["South Dakota Progressives"],
      sliders: ["45%", "60%", "40%", "35%"]
    }
  ];
  ...
  const republicanCandidates = [
    {
      name: "Mike Rounds (R)",
      image: "rounds.jpg",
      bio: "Incumbent U.S. Senator and former Governor of South Dakota, focused on fiscal conservatism, national defense, and agriculture.",
      ideology: "Conservative Republican",
      endorsements: ["South Dakota Republican Party", "National Federation of Independent Business"],
      sliders: ["85%", "70%", "55%", "60%"]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      {/* Header Section (Idaho/Montana style) */}
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          South Dakota U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming soon) polling trends for South Dakota’s 2026 U.S. Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * South Dakota uses a closed primary system. Only registered party members may vote in their party's primary.
        </p>
      </div>
...
// Candidate card with circular photo (Idaho/Montana style)
