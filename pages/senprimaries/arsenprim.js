...
export default function ArkansasSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Hallie Shoffner (D)",
      image: "shoffner.jpg",
      bio: "Community leader focused on education reform and healthcare access.",
      ideology: "Progressive Democrat",
      endorsements: ["Arkansas Teachers Association"],
      sliders: ["70%", "80%", "60%", "50%"],
    },
    {
      name: "Dan Whitfield (D)",
      image: "whitfield.jpg",
      bio: "Former local official and business advocate focused on economic development and transparency.",
      ideology: "Moderate Democrat",
      endorsements: ["Arkansas Chamber of Commerce Democrats"],
      sliders: ["60%", "65%", "50%", "55%"],
    },
  ];
  ...
  const republicanCandidates = [
    {
      name: "Tom Cotton (R)",
      image: "cotton.jpg",
      bio: "Incumbent U.S. Senator emphasizing national security, agriculture, and conservative values.",
      ideology: "Establishment Conservative",
      endorsements: ["Arkansas GOP", "National Rifle Association"],
      sliders: ["85%", "55%", "45%", "70%"],
    },
  ];

  const potentialContenders = []; // No early rumors or potential names yet
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Arkansas U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological positions, and early polling trends for Arkansas’s 2026 U.S. Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Arkansas uses a closed primary system. Only registered party members may vote in their party’s primary.
        </p>
      </div>
