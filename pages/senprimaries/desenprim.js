...
export default function DelawareSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Chris Coons (D)",
      image: "coons.jpg",
      bio: "Incumbent U.S. Senator since 2010, known for bipartisan work on judiciary, foreign policy, and climate.",
      ideology: "Center-Left Democrat",
      endorsements: ["Delaware Democratic Party", "President Joe Biden"],
      sliders: ["55%", "60%", "40%", "50%"],
    },
  ];

  const republicanCandidates = []; // none yet

  const potentialContenders = [
    { name: "Hunter Biden (D)", image: "hbiden.jpg" },
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Delaware U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological profiles, and possible contenders in Delaware’s Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Delaware uses a closed primary system. Only registered party members may vote in their party’s primary.
        </p>
      </div>
