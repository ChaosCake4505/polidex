...
export default function MississippiSenPrimariesPage() {
  const democraticCandidates = []; // No declared Democrats

  const republicanCandidates = [
    {
      name: "Sarah Adlakha (R)",
      image: "adlakha.jpg",
      bio: "Physician and first-time candidate emphasizing public health and community outreach.",
      ideology: "Moderate Conservative",
      endorsements: ["Mississippi Medical PAC"],
      sliders: ["60%", "70%", "55%", "50%"],
    },
    {
      name: "Cindy Hyde-Smith (R)",
      image: "hydesmith.jpg",
      bio: "Incumbent U.S. Senator since 2018 and former Mississippi Commissioner of Agriculture and Commerce.",
      ideology: "Traditional Conservative",
      endorsements: ["Donald Trump", "National Right to Life Committee"],
      sliders: ["85%", "65%", "45%", "70%"],
    },
  ];

  const potentialContenders = [{ name: "Scott Colom (D)", image: "colom.jpg" }];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Mississippi U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological positions, and potential matchups for Mississippi’s 2026 Senate election.
        </p>
        <p className="text-sm italic text-gray-400">
          * Mississippi uses a closed primary system. Only registered party members may vote in their party's primary.
        </p>
      </div>
