...
export default function NewMexicoSenatePrimariesPage() {
  const democraticCandidates = [
    {
      name: "Ben Ray Luján (D)",
      image: "raylujan.jpg",
      bio: "Incumbent U.S. Senator and former U.S. Representative known for broadband expansion and healthcare advocacy.",
      ideology: "Progressive",
      endorsements: ["AFSCME", "League of Conservation Voters"],
      sliders: ["75%", "80%", "50%", "45%"]
    }
  ];
  ...
  const republicanCandidates = [
    {
      name: "Nella Domenici (R)",
      image: "domenici.png",
      bio: "Former Bridgewater CFO and daughter of late Senator Pete Domenici, running on fiscal responsibility and energy leadership.",
      ideology: "Business Conservative",
      endorsements: ["NM Oil & Gas Association PAC"],
      sliders: ["30%", "25%", "70%", "60%"]
    }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          New Mexico U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming soon) polling trends for New Mexico’s 2026 U.S. Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * New Mexico uses a closed primary system. Voters must be registered party members to participate in their party's primary.
        </p>
      </div>
