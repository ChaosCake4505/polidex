...
export default function MassachusettsSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Ed Markey (D)",
      image: "markey.jpg",
      bio: "Incumbent U.S. Senator since 2013, former U.S. Representative with a long record on climate policy and progressive causes.",
      ideology: "Progressive Democrat",
      endorsements: ["Massachusetts Democratic Party"],
      sliders: ["50%", "65%", "55%", "60%"],
    },
    {
      name: "Alex Rikleen (D)",
      image: "rikleen.webp",
      bio: "History teacher focused on education reform, civic engagement, and local community activism.",
      ideology: "Progressive Democrat",
      endorsements: [],
      sliders: ["40%", "55%", "60%", "45%"],
    },
  ...
  const republicanCandidates = [
    {
      name: "John Deaton (R)",
      image: "deaton.jpg",
      bio: "Attorney and 2024 Republican nominee for U.S. Senate aiming to expand outreach and primary challenge.",
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Massachusetts U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological profiles, and early matchups in Massachusetts’s Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Massachusetts uses a semi-closed primary system. Unaffiliated voters may participate after requesting a party ballot.
        </p>
      </div>
