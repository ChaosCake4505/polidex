...
export default function TennesseeSenPrimariesPage() {
  ...
  const republicanCandidates = [
    {
      name: "Bill Hagerty (R)",
      image: "hagerty.jpg",
      bio: "Incumbent U.S. Senator since 2021, former U.S. Ambassador to Japan and economic policy executive.",
      ideology: "Business-oriented Conservative",
      endorsements: ["Tennessee GOP", "Chamber of Commerce"],
      sliders: ["85%", "60%", "45%", "75%"],
    },
  ];

  const potentialContenders = []; // None identified yet
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Tennessee U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological profiles, and potential runoff matchups for Tennessee’s 2026 U.S. Senate cycle.
        </p>
        <p className="text-sm italic text-gray-400">
          * Tennessee uses a closed primary system. Only registered party members may vote in their party's primary.
        </p>
      </div>
      ...
      <div className="w-full max-w-6xl mx-auto bg-gray-800/90 rounded-lg p-8 shadow my-12">
        <h2 className="text-2xl font-bold text-center mb-8">Democratic Primary</h2>
