...
export default function MaineSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "David Costello (D)",
      image: "costello.jpg",
      bio: "Consultant and former Deputy Secretary of the Maryland Department of the Environment; 2024 U.S. Senate nominee.",
      ideology: "Progressive Democrat",
      endorsements: [],
      sliders: ["65%", "75%", "55%", "45%"],
    },
    {
      name: "Tucker Favreau (D)",
      image: "favreau.jpg",
      bio: "Cybersecurity professional with a focus on digital infrastructure and privacy reform.",
      ideology: "Technocratic Liberal",
      endorsements: [],
      sliders: ["55%", "65%", "50%", "50%"],
    },
    {
      name: "Jordan Wood (D)",
      image: "wood.jpg",
      bio: "Former Chief of Staff to U.S. Representative Katie Porter in California, emphasizing housing and anti-corruption policy.",
      ideology: "Progressive Reformist",
      endorsements: [],
      sliders: ["70%", "60%", "60%", "40%"],
    },
       {
      name: "Graham Platner (D)",
      image: "platner.jpg",
      bio: "Sullivan Harbor Master.",
      ideology: "Progressive Populist",
      endorsements: ["Bernie Sanders"],
      sliders: ["70%", "60%", "60%", "40%"],
    },
  ];
  ...
  const republicanCandidates = [
    {
      name: "Dan Smeriglio (R)",
      image: "smeriglio.jpg",
      bio: "Former police officer focused on public safety, immigration enforcement, and veteran support.",
      ideology: "Law-and-Order Conservative",
      endorsements: [],
      sliders: ["70%", "65%", "60%", "65%"],
    },
    {
      name: "Susan Collins (R)",
      image: "collins.webp",
      bio: "Incumbent U.S. Senator since 1997, known for moderate stances and bipartisan negotiation.",
      ideology: "Moderate Republican",
      endorsements: ["Senate Republican Leadership"],
      sliders: ["50%", "60%", "45%", "55%"],
    },
  ];

  const potentialContenders = [
    { name: "Cathy Breen (D)", image: "breen.jpeg" },
    { name: "Ryan Fecteau (D)", image: "fecteau.jpg" },
    { name: "Dan Kleban (D)", image: "kleban.jpg" },
    { name: "Janet Mills (D)", image: "mills.jpg" },
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Maine U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological profiles, and early polling trends for Maine’s U.S. Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Maine uses a closed primary system. Only registered party members may vote in their party's primary.
        </p>
      </div>
