...
export default function KansasSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Mike Soetaert (D)",
      image: "soetaert.jpg",
      bio: "Community organizer and policy analyst with a focus on education and healthcare equity.",
      ideology: "Progressive Democrat",
      endorsements: ["Kansas Educators Association"],
      sliders: ["65%", "60%", "70%", "50%"]
    }
  ];
  ...
  const republicanCandidates = [
    {
      ...
      image: "marshall.jpg",
      bio: "Incumbent U.S. Senator emphasizing border security, agriculture, and conservative values.",
      ideology: "Mainstream Conservative",
      endorsements: ["Kansas Farm Bureau", "NRA"],
      sliders: ["80%", "75%", "60%", "70%"]
    }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Kansas U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming soon) polling trends for Kansas’s 2026 U.S. Senate primaries.
        </p>
