...
export default function IdahoSenPrimariesPage() {
  const democraticCandidates = [
    {
      name: "David Roth (D)",
      image: "roth.jpg",
      bio: "Democratic nominee for Senate in 2022 and housing advocate focused on economic justice and education.",
      ideology: "Center-left Democrat",
      endorsements: ["Idaho Democratic Party"],
      sliders: ["35%", "60%", "45%", "30%"]
    }
  ];
  ...
  const republicanCandidates = [
    {
      name: "Jim Risch (R)",
      image: "risch.jpg",
      bio: "Incumbent U.S. Senator since 2009 and former Governor of Idaho, known for national security and pro-business policy.",
      ideology: "Conservative Republican",
      endorsements: ["Idaho Republican Party", "National Rifle Association"],
      sliders: ["85%", "75%", "60%", "70%"]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      {/* Header Section (Minnesota/Arizona style) */}
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Idaho U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming soon) polling trends for Idaho’s 2026 U.S. Senate primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Idaho uses a closed primary system. Only registered party members may vote in their party's primary.
        </p>
      </div>
...
// Candidate card with circular photo (Minnesota/Arizona style)
