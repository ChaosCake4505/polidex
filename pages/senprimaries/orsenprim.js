...
export default function OregonSenatePrimariesPage() {
  const democraticCandidates = [
    {
      name: "Jeff Merkley (D)",
      image: "merkley.jpg",
      bio: "Incumbent U.S. Senator known for progressive stances on climate and economic justice.",
      ideology: "Progressive",
      endorsements: ["Planned Parenthood", "League of Conservation Voters"],
      sliders: ["80%", "90%", "40%", "30%"]
    }
  ];
  ...
  const republicanCandidates = [
    {
      name: "Tim Skelton (R)",
      image: "skelton.png",
      bio: "Business executive and political newcomer emphasizing energy independence and border security.",
      ideology: "Conservative",
      endorsements: ["Oregon Business Coalition"],
      sliders: ["20%", "35%", "70%", "60%"]
    }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          Oregon U.S. Senate Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming soon) polling trends for Oregon’s 2026 U.S. Senate primaries.
        </p>
