...
export default function AlaskaSenPrimariesPage() {
  const candidates = [
    {
      name: "Dan Sullivan (R)",
      image: "sullivan.jpg",
      bio: "Incumbent U.S. Senator from Alaska since 2015 and former Alaska Attorney General.",
      ideology: "Conservative Republican",
      endorsements: ["Alaska Republican Party", "National Rifle Association"],
      sliders: ["85%", "75%", "60%", "65%"]
    }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Alaska U.S. Senate Open Primary
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming soon) polling trends for Alaska’s 2026 U.S. Senate <strong>top-four nonpartisan primary</strong>.
        </p>
