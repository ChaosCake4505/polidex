...
export default function NebraskaGovPrimariesPage() {
  ...
  const republicanCandidates = [
    {
      name: "Jim Pillen (R)",
      image: "pillen.jpg",
      bio: "Incumbent Governor of Nebraska focused on tax relief and education reform.",
      ideology: "Mainstream Conservative",
      endorsements: ["Nebraska Republican Party"],
      sliders: ["65%", "70%", "60%", "55%"] // fixed percent
    },
    {
      name: "Jacy Todd (R)",
      image: "todd.jpg",
      bio: "Rancher and former county commissioner running on agricultural revitalization.",
      ideology: "Populist Conservative",
      endorsements: ["Rural Values Coalition"],
      sliders: ["80%", "60%", "75%", "70%"]
    }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Nebraska Governor Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared and potential candidates, ideological placements, and (coming soon) polling trends for Nebraska’s 2026 gubernatorial primaries.
        </p>
