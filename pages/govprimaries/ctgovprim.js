...
export default function ConnecticutGovPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Josh Elliott (D)",
      image: "elliott.jpg",
      bio: "State representative from the 88th district since 2017 and former candidate for secretary of the state.",
      ideology: "Progressive Democrat",
      endorsements: ["Connecticut Working Families Party"],
      sliders: ["45%", "60%", "55%", "40%"]
    }
  ];
  ...
  const republicanCandidates = [
    {
      name: "Jennifer Tooker (R)",
      image: "tooker.jpg",
      bio: "Republican municipal leader in Connecticut.",
      ideology: "Mainstream Conservative",
      endorsements: ["Connecticut GOP"],
      sliders: ["70%", "55%", "60%", "50%"]
    }
  ];

  const potentialCandidates = [
    { name: "Ned Lamont (D)", image: "lamont.jpg" },
    { name: "Luke Bronin (D)", image: "bronin.jpg" },
    { name: "Susan Bysiewicz (D)", image: "bysiewicz.jpg" },
    { name: "Sean Scanlon (D)", image: "scanlon.jpg" },
    { name: "William Tong (D)", image: "tong.jpg" },
    { name: "Erin Stewart (R)", image: "stewart.jpg" },
    { name: "Ryan Fazio (R)", image: "fazio.jpg" },
    { name: "Peter Lumaj (R)", image: "lumaj.jpg" },
    { name: "Rob Sampson (R)", image: "sampson.jpg" },
    { name: "Heather Somers (R)", image: "somers.png" }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        ...
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological positions, and potential contenders in Connecticut’s 2026 gubernatorial primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Connecticut uses a closed primary system. Only registered party members may vote in their party’s primary.
        </p>
      </div>
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow max-w-7xl mx-auto my-16 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center min-w-[800px] min-h-[420px] items-center text-gray-400">
          {/* Drop in <DemCountyMapCT /> when ready */}
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow max-w-7xl mx-auto my-16 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center min-w-[800px] min-h-[420px] items-center text-gray-400">
          {/* Drop in <RepCountyMapCT /> when ready */}
