...
// const DemCountyMapAL = dynamic(() => import("../../components/algovprim/DemCountyMapAL"), { ssr: false });
// const RepCountyMapAL = dynamic(() => import("../../components/algovprim/RepCountyMapAL"), { ssr: false });

export default function AlabamaGovPrimariesPage() {
  // ---- POLLING (add rows when available) ----
  const demRaw = [
    // Example: { period: "Jun 10–12, 2025", Boyd: 28, Brown: 22, Martin: 18, Undecided: 32 }
  ];
  const repRaw = [
    // Example: { period: "Jun 10–12, 2025", McFeeters: 14, Tuberville: 46, Undecided: 40 }
  ];
  ...
  const demKeys = ["Boyd", "Brown", "Martin"];
  const repKeys = ["McFeeters", "Tuberville"];
  ...
  const democraticCandidates = [
    {
      name: "Will Boyd (D)",
      image: "boyd.jpg",
      bio: "2022 U.S. Senate nominee and pastor focused on social justice and healthcare reform.",
      ideology: "Progressive Democrat",
      endorsements: ["Alabama Democratic Conference"],
      sliders: ["30%", "35%", "65%", "40%"],
    },
    {
      name: "Ja'Mel Brown (D)",
      image: "brown.jpeg",
      bio: "Community organizer and education advocate from Birmingham.",
      ideology: "Grassroots Progressive",
      endorsements: ["NAACP Alabama", "Alabama Young Democrats"],
      sliders: ["25%", "30%", "70%", "45%"],
    },
    {
      name: "Chad Chig Martin (D)",
      image: "martin.jpg",
      bio: "Entrepreneur and former mayoral candidate focused on economic opportunity and rural development.",
      ideology: "Moderate Democrat",
      endorsements: ["Alabama Rural Caucus"],
      sliders: ["45%", "50%", "55%", "50%"],
    },
  ];
  ...
  const republicanCandidates = [
    {
      name: "Ken McFeeters (R)",
      image: "mcfeeters.jpg",
      bio: "Business leader and former county commissioner focused on conservative fiscal policy.",
      ideology: "Mainstream Conservative",
      endorsements: ["Alabama Republican Party"],
      sliders: ["75%", "80%", "55%", "60%"],
    },
    {
      name: "Tommy Tuberville (R)",
      image: "tuberville.jpg",
      bio: "U.S. Senator and former Auburn football coach known for staunch conservative stances.",
      ideology: "Hardline Conservative",
      endorsements: ["NRA", "Club for Growth"],
      sliders: ["90%", "85%", "50%", "80%"],
    },
  ];

  const potentialCandidates = [{ name: "Doug Jones (D)", image: "jones.jpg" }];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">Alabama Governor Primaries</h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared, potential candidates, ideological placements, and polling trends for Alabama’s 2026 gubernatorial primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Alabama uses an open primary and holds a runoff if no candidate receives a majority.
        </p>
      </div>
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow max-w-7xl mx-auto my-16 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center min-w-[800px]">
          ...
          <span className="text-gray-400 text-lg">
            County-level map for the Democratic primary will appear here when available.
          </span>
        </div>
      </div>
            ...
            <LineChart data={repPolling} margin={{ top: 10, right: 20, left: 0, bottom: 5 }}>
              ...
              {repKeys.map((key, idx) => (
                <Line
                  ...
                  dataKey={key}
                  name={key}
                  stroke={["#ef4444", "#60a5fa", "#f97316", "#a21caf"][idx % 4]}
                  dot={{ r: 3 }}
                />
              ))}
            </LineChart>
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow max-w-7xl mx-auto my-16 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center min-w-[800px]">
          {/* <RepCountyMapAL /> */}
          <span className="text-gray-400 text-lg">
            County-level map for the Republican primary will appear here when available.
          </span>
        </div>
      </div>
...
// Candidate card (circular photo), matching Michigan style
