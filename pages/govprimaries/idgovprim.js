...
export default function IdahoGovPrimariesPage() {
  const republicanCandidates = [
    {
      name: "Brad Little (R)",
      image: "little.jpg",
      bio: "Incumbent Governor of Idaho known for conservative fiscal policy and business-friendly governance.",
  ...
  const potentialCandidates = [
    { name: "Russ Fulcher (R)", image: "fulcher.jpg" }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Idaho Governor Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared and potential candidates, ideological placements, and (coming soon) polling trends for Idaho’s 2026 gubernatorial primaries.
        </p>
