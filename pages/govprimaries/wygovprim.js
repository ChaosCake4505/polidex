...
export default function WyomingGovPrimariesPage() {
  const republicanCandidates = [
    {
      name: "Brent Bien (R)",
      image: "bien.jpg",
      bio: "Former U.S. Marine and conservative activist focusing on government accountability and individual liberty.",
      ideology: "Conservative",
      endorsements: ["Wyoming Liberty Group", "Freedom Caucus Network"],
      sliders: ["85%", "70%", "60%", "75%"]
    },
    {
      name: "Joseph Kibler (R)",
      image: "kibler.jpg",
      bio: "Businessman and political newcomer emphasizing economic development and constitutional rights.",
      ideology: "Right-Wing Populist",
      endorsements: ["Wyoming Patriots Alliance"],
      sliders: ["90%", "65%", "75%", "70%"]
    }
  ];

  const potentialCandidates = [
    { name: "Harriet Hageman (R)", image: "hageman.jpg" },
    { name: "Mark Gordon (R)", image: "gordon.jpg" }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Wyoming Governor Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared and potential candidates, ideological placements, and (coming soon) polling trends for Wyoming’s 2026 gubernatorial primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Wyoming uses a closed primary system. Only registered party members may vote in their party's primary.
        </p>
      </div>
      ...
      {/* Democratic Candidates (empty state) */}
      <div className="w-full max-w-6xl mx-auto bg-gray-800/90 rounded-lg p-8 shadow my-12">
