...
export default function NewYorkGovPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Antonio Delgado (D)",
      image: "delgado.jpg",
      bio: "Lieutenant Governor of New York since 2022.",
      ideology: "Progressive Democrat",
      endorsements: ["Working Families Party", "Upstate Coalition PAC"],
      sliders: ["40%", "50%", "60%", "45%"]
    },
    {
      name: "Kathy Hochul (D)",
      image: "hochul.jpg",
      bio: "Incumbent Governor of New York since 2021.",
      ideology: "Establishment Democrat",
      endorsements: ["New York State Democratic Committee", "Emily's List"],
      sliders: ["35%", "40%", "70%", "55%"]
    }
  ];
  ...
  const republicanCandidates = [
    {
      name: "Carl Hyde Jr. (R)",
      image: "hydejr.jpg",
      bio: "Declared Republican challenger for the 2026 gubernatorial race.",
      ideology: "Conservative Populist",
      endorsements: ["State Liberty Caucus"],
      sliders: ["85%", "40%", "60%", "65%"]
    }
  ];

  const potentialCandidates = [
    { name: "Bruce Blakeman (R)", image: "blakeman.jpg" },
    { name: "John Catsimatidis (R)", image: "catsimatidis.jpg" },
    { name: "Betsy McCaughey (R)", image: "mccaughey.jpg" },
    { name: "Elise Stefanik (R)", image: "stefanik.jpg" }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        ...
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and potential challengers in New York’s 2026 gubernatorial primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * New York uses a closed primary system. Only registered party members may vote in their party’s primary.
        </p>
      </div>
