...
export default function HawaiiGovPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Josh Green (D)",
      image: "green.jpg",
      bio: "Lieutenant Governor of Hawaii and former emergency physician.",
      ideology: "Moderate Democrat",
      endorsements: ["Hawaii Democratic Party", "Hawaii State AFL-CIO"],
      sliders: ["60%","55%","50%","45%"]
    }
  ];
  ...
  const potentialCandidates = [
    // Add names/images here when you have them, or leave empty
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Hawaii Governor Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming soon) polling trends for Hawaii’s 2026 gubernatorial primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Hawaii uses a closed primary system. Only registered party members may vote in their party's primary.
        </p>
      </div>
      ...
      <div className="w-full max-w-6xl mx-auto bg-gray-800/90 rounded-lg p-8 shadow my-12">
        ...
        {republicanCandidates.length === 0 ? (
          <p className="text-center text-white italic">No declared Republican candidates yet.</p>
        ) : (
          <div className="grid gap-8 md:grid-cols-2">
      ...
      <div className="w-full max-w-6xl mx-auto bg-gray-800/90 rounded-lg p-8 shadow my-12">
        ...
        {potentialCandidates.length === 0 ? (
          <p className="text-center text-white italic">No potential contenders listed yet.</p>
        ) : (
...
// Card with circular photo & four sliders (Iowa style)
