...
export default function NewMexicoGovPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Sam Bregman (D)",
      image: "bregman.jpg",
      bio: "Chair of the New Mexico Democratic Party and former Bernalillo County commissioner.",
      ideology: "Establishment Democrat",
      endorsements: ["New Mexico Democratic Party"],
      sliders: ["55%", "50%", "60%", "45%"]
    },
    {
      name: "Deb Haaland (D)",
      image: "haaland.jpg",
      bio: "U.S. Secretary of the Interior and former Congresswoman focused on Indigenous and environmental justice.",
      ideology: "Progressive Democrat",
      endorsements: ["EMILY's List", "League of Conservation Voters"],
      sliders: ["20%", "30%", "65%", "40%"]
    },
    {
      name: "Ken Miyagishima (D)",
      image: "miyagishima1.jpg",
      bio: "Mayor of Las Cruces with a focus on local development and housing access.",
      ideology: "Moderate Democrat",
      endorsements: ["Local Municipal Coalitions"],
      sliders: ["50%", "55%", "50%", "45%"]
    }
  ];
  ...
  const republicanCandidates = [
    {
      name: "Gregg Hull (R)",
      image: "hull.jpg",
      bio: "Mayor of Rio Rancho known for business-friendly policies and infrastructure investment.",
      ideology: "Mainstream Conservative",
      endorsements: ["New Mexico Business Coalition"],
      sliders: ["70%", "75%", "60%", "65%"]
    }
  ];

  const potentialCandidates = [
    { name: "Mark Murphy (R)", image: "mumurphy.jpg" },
    { name: "Judith Nakamura (R)", image: "nakamura.jpg" },
    { name: "Yvette Herrell (R)", image: "herrell.jpg" },
    { name: "Susana Martinez (R)", image: "martinez.jpg" },
    { name: "Mark Ronchetti (R)", image: "ronchetti.jpg" },
    { name: "John Sanchez (R)", image: "sanchez.jpg" }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          New Mexico Governor Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared and potential candidates, ideological placements, and (coming soon) polling trends for New Mexico’s 2026 gubernatorial primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * New Mexico uses a closed primary system. Only registered party members may vote in their party's primary.
        </p>
      </div>
