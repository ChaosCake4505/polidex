...
export default function MassachusettsGovPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Maura Healey (D)",
      image: "healey.jpg",
      bio: "Incumbent governor of Massachusetts since 2023.",
      ideology: "Progressive Democrat",
      endorsements: ["Massachusetts Democratic Party", "Planned Parenthood Action Fund"],
      sliders: ["30%", "40%", "65%", "45%"]
    }
  ];
  ...
  const republicanCandidates = [
    {
      name: "Mike Kennealy (R)",
      image: "kennealy.jpg",
      bio: "Former Massachusetts Secretary of Housing and Economic Development.",
      ideology: "Pro-Business Conservative",
      endorsements: ["Massachusetts Fiscal Alliance"],
      sliders: ["70%", "80%", "50%", "55%"]
    },
    {
      name: "Brian Shortsleeve (R)",
      image: "shortsleeve.jpg",
      bio: "Former MBTA chief administrator and acting general manager.",
      ideology: "Reform-Oriented Technocrat",
      endorsements: ["Boston Business Roundtable"],
      sliders: ["60%", "75%", "55%", "50%"]
    }
  ];

  const potentialCandidates = [
    { name: "Lewis Evangelidis (R)", image: "evangelidis.jpg" },
    { name: "Michael Minogue (R)", image: "minogue.png" },
    { name: "Michael Soter (R)", image: "sorter.JPEG" },
    { name: "Bruce Tarr (R)", image: "tarr.jpg" },
    { name: "Karyn Polito (R)", image: "polito.jpg" }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        ...
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared and potential candidates, ideological placements, and (coming soon) polling trends for Massachusetts’s 2026 gubernatorial primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Massachusetts uses an open primary system. Any registered voter may participate in any party's primary.
        </p>
      </div>
