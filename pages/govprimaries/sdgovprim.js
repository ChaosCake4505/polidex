...
export default function SouthDakotaGovPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Robert Arnold (D)",
      image: "arnold.jpg",
      bio: "Democratic community leader and advocate for healthcare and education reform.",
      ideology: "Progressive Democrat",
      endorsements: ["South Dakota Democratic Party"],
      sliders: ["60%", "50%", "55%", "45%"],
    },
  ];
  ...
  const republicanCandidates = [
    {
      name: "Toby Doeden (R)",
      image: "doeden.jpg",
      bio: "Businessman and conservative activist focused on fiscal responsibility.",
      ideology: "Anti-Establishment Conservative",
      endorsements: ["Freedom Caucus South Dakota"],
      sliders: ["85%", "65%", "80%", "70%"],
    },
    {
      name: "Jon Hansen (R)",
      image: "jhansen.jpg",
      bio: "State Representative known for pro-life advocacy and legislative leadership.",
      ideology: "Social Conservative",
      endorsements: ["South Dakota Right to Life"],
      sliders: ["75%", "60%", "70%", "80%"],
    },
    {
      name: "Dusty Johnson (R)",
      image: "djohnson.jpg",
      bio: "U.S. Congressman with a reputation for pragmatic conservatism and bipartisan work.",
  ...
  const potentialCandidates = [
    { name: "Larry Rhoden (R)", image: "rhoden.jpg" },
    { name: "Tony Venhuizen (R)", image: "venhuizen.jpg" },
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          South Dakota Governor Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared and potential candidates, ideological placements, and (coming soon) polling trends for South Dakota’s 2026 gubernatorial primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * South Dakota parties may invite independents to vote in their primaries (Democrats typically do). Republicans remain closed.
        </p>
      </div>
