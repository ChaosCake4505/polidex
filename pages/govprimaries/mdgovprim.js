...
export default function MarylandGovPrimariesPage() {
  const democraticCandidates = [
    {
      name: "Ed Hale (D)",
      image: "hale.jpg",
      bio: "Retired banker and owner of the Baltimore Blast.",
      ideology: "Business Democrat",
      endorsements: ["Baltimore Business Coalition"],
      sliders: ["60%", "50%", "55%", "45%"]
    },
    {
      name: "Wes Moore (D)",
      image: "moore.jpg",
      bio: "Incumbent governor of Maryland since 2023.",
      ideology: "Progressive Democrat",
      endorsements: ["Maryland Democratic Party", "Working Families Party"],
      sliders: ["35%", "30%", "65%", "50%"]
    }
  ];
  ...
  const republicanCandidates = [
    {
      name: "John Myrick (R)",
      image: "myrick.jpg",
      bio: "Federal executive consultant and 2024 U.S. Senate candidate.",
      ideology: "Conservative Technocrat",
      endorsements: ["Maryland GOP"],
      sliders: ["75%", "60%", "50%", "60%"]
    },
    {
      name: "Kurt Wedekind (R)",
      image: "wedekin.jpg",
      bio: "Conservative figure in Maryland politics.",
      ideology: "Hardline Conservative",
      endorsements: ["State Tea Party Coalition"],
      sliders: ["85%", "70%", "65%", "55%"]
    }
  ];

  const potentialCandidates = [
    { name: "Christopher Bouchat (R)", image: "bouchat.jpg" },
    { name: "Larry Hogan (R)", image: "hogan.jpg" }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Maryland Governor Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and potential challengers in Maryland’s 2026 gubernatorial primaries.
        </p>
...
// Card: matches other modern primary pages, round images for candidates/potentials
