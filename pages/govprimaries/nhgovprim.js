...
export default function NewHampshireGovPrimariesPage() {
  // DEMs and REPs (you can add more as needed)
  const democraticCandidates = [];
  const republicanCandidates = [
    {
      name: "Kelly Ayotte (R)",
      image: "ayotte.webp",
      bio: "Incumbent governor of New Hampshire since 2025 and former U.S. Senator.",
      ideology: "Moderate Conservative",
      endorsements: ["New Hampshire GOP", "Chamber of Commerce"],
      sliders: ["65%", "60%", "55%", "50%"]
    }
  ];

  const potentialCandidates = [
    { name: "Tom Sherman (D)", image: "sherman.jpg" }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight">
          New Hampshire Governor Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Explore declared candidates, ideological placements, and (coming soon) polling trends for New Hampshire’s 2026 gubernatorial primaries.
        </p>
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow max-w-7xl mx-auto my-16 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center min-w-[800px] min-h-[420px] items-center text-gray-400">
          {/* Drop in <DemCountyMapNH /> when ready */}
      ...
      <div className="w-full max-w-6xl mx-auto bg-gray-800/90 rounded-lg p-8 shadow my-12">
        ...
        {democraticCandidates.length === 0 ? (
          <div className="text-center text-gray-400 italic text-lg py-12">
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow max-w-7xl mx-auto my-16 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center min-w-[800px] min-h-[420px] items-center text-gray-400">
          {/* Drop in <RepCountyMapNH /> when ready */}
