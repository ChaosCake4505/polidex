...
export default function VermontGovPrimariesPage() {
  const democraticCandidates = []; // No Democratic candidates yet

  const republicanCandidates = [
    {
      name: "Phil Scott (R)",
      image: "pscott.jpg",
      bio: "Incumbent governor of Vermont since 2017, known for moderate and bipartisan leadership.",
      ideology: "Moderate Republican",
      endorsements: ["Vermont Republican Party", "Various bipartisan coalitions"],
      sliders: ["45%", "55%", "40%", "60%"]
    }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Vermont Governor Primaries
        </h1>
        <p className="max-w-3xl mx-auto text-lg mb-2">
          Track candidates, profiles, and (coming soon) polling trends for Vermont’s 2026 gubernatorial primaries.
        </p>
        <p className="text-sm italic text-gray-400">
          * Vermont uses an open primary system. Any registered voter may vote in any party's primary.
        </p>
      </div>
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow max-w-7xl mx-auto my-16 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center min-w-[800px] min-h-[420px] items-center text-gray-400">
          {/* Drop in <DemCountyMapVT /> when ready */}
      ...
      <div className="w-full max-w-6xl mx-auto bg-gray-800/90 rounded-lg p-8 shadow my-12">
        ...
        <p className="text-white text-center italic">No Democratic candidates have declared yet.</p>
      </div>
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow max-w-7xl mx-auto my-16 flex flex-col items-center">
        ...
        <div className="w-full flex justify-center min-w-[800px] min-h-[420px] items-center text-gray-400">
          {/* Drop in <RepCountyMapVT /> when ready */}
      ...
      <div className="w-full max-w-6xl mx-auto bg-gray-800/90 rounded-lg p-8 shadow my-12">
        ...
        <p className="text-white text-center italic">No additional potential candidates at this time.</p>
      </div>
