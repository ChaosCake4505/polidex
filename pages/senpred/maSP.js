...
export default function MassachusettsSenatePage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex Forecasts that <span className="text-blue-400">Ed Markey</span>
          <br />is the Favorite in the Massachusetts Senate Race.
        </h1>
        <p className="text-lg font-sans">
          <span className="text-blue-400">Democrats</span> have a{" "}
          <span className="text-blue-400">99%</span> Chance of Victory. Predicted Margin:{" "}
          <strong className="text-blue-400">Safe D</strong>
        </p>
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * Massachusetts uses a semi-closed primary system. Unenrolled voters may choose a party ballot to vote in.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="Ed Markey"
          party="Democrat"
          percent={<span className="text-blue-400">63.5%</span>}
          image="/markey.jpg"
        />
        <div className="text-center text-gray-300">
          <p className="text-lg font-sans">Chance of Victory</p>
          <p className="text-2xl font-bold mt-1 text-blue-400 font-sans">Democrats 99%</p>
        </div>
        <CandidateCard
          name="TBA"
          party="Republican"
          percent={<span className="text-[#FF5865]">34.2%</span>}
          image="/goplogo2.png"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[300px] text-gray-300 text-lg">
          Massachusetts map visualization will appear here when available.
        </div>
      </div>
      ...
      <div className="text-center mb-12">
        ...
        >
          View Massachusetts Senate Primaries →
        </Link>
      </div>
