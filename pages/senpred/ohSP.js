...
export default function OhioSenatePage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex Forecasts that <span className="text-[#FF5865]">Jon Husted</span>
          <br />are Slightly Favored to Win the Ohio Senate Race.
        </h1>
        <p className="text-lg font-sans">
          <span className="text-[#FF5865]">Republicans</span> have a{" "}
          <span className="text-[#FF5865]">72%</span> Chance of Victory. Predicted Margin:{" "}
          <strong className="text-[#FF5865]">Lean R</strong>
        </p>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="Sherrod Brown"
          party="Democrat"
          percent={<span className="text-blue-400">47.8%</span>}
          image="/sbrown.jpg"
        />
        <div className="text-center text-gray-300">
          <p className="text-lg font-sans">Chance of Victory</p>
          <p className="text-2xl font-bold mt-1 text-[#FF5865] font-sans">Republicans 72%</p>
        </div>
        <CandidateCard
          name="Jon Husted"
          party="Republican"
          percent={<span className="text-[#FF5865]">51.6%</span>}
          image="/husted.jpg"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[300px] text-gray-300 text-lg">
          Ohio map visualization will appear here when available.
        </div>
      </div>
