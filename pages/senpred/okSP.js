...
export default function OklahomaSenPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          ...
          <br />are Favored to Win the Oklahoma Senate Race.
        </h1>
        ...
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * Oklahoma uses a closed primary system. Only registered party members may vote in their party's primary.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="TBA"
          party="Democrat"
          percent={<span className="text-blue-400">35.4%</span>}
          image="/demlogo.png"
        />
        ...
        <CandidateCard
          name="TBA"
          party="Republican"
          percent={<span className="text-[#FF5865]">62.8%</span>}
          image="/goplogo2.png"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[300px] text-gray-300 text-lg">
          {/* Replace with <SenStateMapOK /> if/when you add a map */}
          Oklahoma map visualization will appear here when available.
        </div>
      </div>
      ...
      <div className="text-center mb-12">
        ...
        >
          View Oklahoma Senate Primaries →
        </Link>
      </div>
