...
export default function IdahoSenPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex Forecasts that <span className="text-[#FF5865]">Jim Risch</span>
        ...
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * Idaho uses a closed primary system. Voters must be registered party members to participate.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="TBA"
          party="Democrat"
          percent={<span className="text-blue-400">37.2%</span>}
          image="/demlogo.png"
        />
        ...
        <CandidateCard
          name="Jim Risch"
          party="Republican"
          percent={<span className="text-[#FF5865]">60.9%</span>}
          image="/risch.jpg"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        <h2 className="text-xl font-semibold mb-4 text-center">Statewide Forecast</h2>
        <div className="w-full flex items-center justify-center min-h-[380px] text-gray-300 text-lg">
          {/* Replace with <SenCountyMapID /> when ready */}
          County/region-level forecast will appear here when available.
        </div>
      </div>
