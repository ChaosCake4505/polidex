...
export default function OregonSenPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex Forecasts that <span className="text-blue-400">Jeff Merkley</span>
          <br />is  Favored to Win the Oregon Senate Race.
        </h1>
        <p className="text-lg font-sans">
          <span className="text-blue-400">Democrats</span> have a{" "}
          <span className="text-blue-400">96%</span> Chance of Victory. Predicted Margin:{" "}
          <strong className="text-blue-400">Safe D</strong>
        </p>
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * Oregon uses a closed primary system. Voters must be registered party members to participate.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="Jeff Merkley"
          party="Democrat"
          percent={<span className="text-blue-400">58.2%</span>}
          image="/merkley.jpg"
        />
        <div className="text-center text-gray-300">
          <p className="text-lg font-sans">Chance of Victory</p>
          <p className="text-2xl font-bold mt-1 text-blue-400 font-sans">Democrats 96%</p>
        </div>
        <CandidateCard
          name="TBA"
          party="Republican"
          percent={<span className="text-[#FF5865]">39.4%</span>}
          image="/goplogo2.png"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[380px] text-gray-300 text-lg">
          {/* Replace with <SenCountyMapOR /> when ready */}
