...
export default function TexasSenPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex Forecasts that <span className="text-red-400">Republicans</span>
          <br />are Favored to Win the Texas Senate Race.
        </h1>
        <p className="text-lg font-sans">
          <span className="text-red-400">Republicans</span> have a{" "}
          <span className="text-red-400">82%</span> Chance of Victory. Predicted Margin:{" "}
          <strong className="text-red-400">Likely R</strong>
        </p>
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * Texas uses an open primary system. Voters may vote in either party's primary, but not both.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="TBA"
          party="Democrat"
          percent={<span className="text-blue-400">45.8%</span>}
          image="/demlogo.png"
        />
        <div className="text-center text-gray-300">
          <p className="text-lg font-sans">Chance of Victory</p>
          <p className="text-2xl font-bold mt-1 text-red-400 font-sans">Republican 82%</p>
        </div>
        <CandidateCard
          name="TBA"
          party="Republican"
          percent={<span className="text-[#FF5865]">52.3%</span>}
          image="/goplogo2.png"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[300px] text-gray-300 text-lg">
          {/* Replace with <SenStateMapTX /> if/when you add a state map */}
          Texas map visualization will appear here when available.
        </div>
      </div>
