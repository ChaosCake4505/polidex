...
export default function NebraskaSenPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex Forecasts that <span className="text-[#FF5865]">Pete Ricketts</span>
          <br />is Favored to Win the Nebraska Senate Race.
        </h1>
        <p className="text-lg font-sans">
          <span className="text-[#FF5865]">Republicans</span> have a{" "}
          <span className="text-[#FF5865]">77%</span> Chance of Victory. <br />
          Predicted Margin: <strong className="text-[#FF5865]">Likely R</strong>
        </p>
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * Nebraska uses a closed primary system. Only registered party members may vote in their party’s primary.
        </p>
      </div>

      {/* Candidate Cards Row (2 candidates) with centered victory chance */}
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="Dan Osborn"
          party="Independent"
          percent={<span className="text-gray-300">46.2%</span>}
          image="/osborn.jpg"
        />
        <div className="text-center text-gray-300">
          <p className="text-lg font-sans">Chance of Victory</p>
          <p className="text-2xl font-bold mt-1 text-[#FF5865] font-sans">Republicans 77%</p>
        </div>
        <CandidateCard
          name="Pete Ricketts"
          party="Republican"
          percent={<span className="text-[#FF5865]">53.1%</span>}
          image="/ricketts.jpg"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[380px] text-gray-300 text-lg">
          {/* Replace with <SenCountyMapNE /> when ready */}
      ...
      <div className="text-center mb-12">
        ...
        >
          View Nebraska Senate Primaries →
        </Link>
      </div>
...
function CandidateCard({ name, party, percent, image }) {
  ...
  const percentColor = isRep ? "text-[#FF5865]" : isInd ? "text-gray-300" : "text-white";
