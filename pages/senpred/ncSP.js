...
export default function NorthCarolinaSenatePage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex rates the North Carolina Senate Race a{" "}
          <span className="text-blue-400">Lean D</span>.
        </h1>
        <p className="text-lg font-sans">
          <strong className="text-blue-400">Roy Cooper</strong> has roughly a <strong className="text-blue-400">64%</strong> chance of victory. Predicted Margin:{" "}
          <strong className="text-blue-400">Lean D</strong>
        </p>
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * North Carolina uses a semi-closed primary: unaffiliated voters may choose which party’s primary to vote in.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="Roy Cooper"
          party="Democrat"
          percent={<span className="text-blue-400">51.7%</span>}
          image="/rcooper.jpg"
        />
        <div className="text-center text-gray-300">
          <p className="text-lg font-sans">Chance of Victory</p>
          <p className="text-2xl font-bold mt-1 text-blue-400 font-sans">Lean D 64%</p>
        </div>
        <CandidateCard
          name="Michael Whatley"
          party="Republican"
          percent={<span className="text-[#FF5865]">47.6%</span>}
          image="/whatley.webp"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[300px] text-gray-300 text-lg">
          North Carolina map visualization will appear here when available.
        </div>
      </div>
      ...
      <div className="text-center mb-12">
        ...
        >
          View North Carolina Senate Primaries →
        </Link>
      </div>
