...
export default function NewJerseySenatePage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex Forecasts that <span className="text-blue-400">Cory Booker</span>
          <br />is the Favorite in the New Jersey Senate Race.
        </h1>
        ...
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * New Jersey uses a closed primary system. Only registered party members may vote in their party’s primary.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="Cory Booker"
          party="Democrat"
          percent={<span className="text-blue-400">56.9%</span>}
          image="/booker.jpg"
        />
        ...
        <CandidateCard
          name="TBA"
          party="Republican"
          percent={<span className="text-[#FF5865]">42.2%</span>}
          image="/goplogo2.png"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[300px] text-gray-300 text-lg">
          New Jersey map visualization will appear here when available.
        </div>
      </div>
      ...
      <div className="text-center mb-12">
        ...
        >
          View New Jersey Senate Primaries →
        </Link>
      </div>
