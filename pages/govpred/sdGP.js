...
export default function SouthDakotaGovPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          ...
          <br />are Heavily Favored to Win the Governor’s Race.
        </h1>
        ...
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * South Dakota primaries are party-run; Republicans are closed, while Democrats may allow independents.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="TBA"
          party="Democrat"
          percent={<span className="text-blue-400">40.0%</span>}
          image="/demlogo.png"
        />
        ...
        <CandidateCard
          name="TBA"
          party="Republican"
          percent={<span className="text-[#FF5865]">59.4%</span>}
          image="/goplogo2.png"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[380px] text-gray-300 text-lg">
          {/* Replace with <GovCountyMapSD /> when ready */}
      ...
      <div className="text-center mb-12">
        ...
        >
          View South Dakota Governor Primaries →
        </Link>
      </div>
