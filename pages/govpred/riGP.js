...
export default function RhodeIslandGovPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex Forecasts that <span className="text-[#577CCC]">Democrats</span>
          <br />is the favorite to win the Rhode Island Governor’s Race.
        </h1>
        <p className="text-lg font-sans">
          <span className="text-[#577CCC]">Democrats</span> have a <span className="text-[#577CCC]">79%</span> Chance of Victory. Predicted Margin: <strong className="text-[#577CCC]">Likely D</strong>
        </p>
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * Rhode Island uses a semi-closed primary system. Unaffiliated voters may choose a party primary to vote in.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        ...
        <div className="text-center text-gray-300">
          ...
          <p className="text-2xl font-bold mt-1 text-[#577CCC] font-sans">Democrats 97%</p>
        </div>
        <CandidateCard
          name="TBA"
          party="Republican"
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[380px] text-gray-300 text-lg">
          {/* Replace with <GovCountyMapRI /> if/when you build a county map */}
      ...
      <div className="text-center mb-12">
        ...
        >
          View Rhode Island Governor Primaries →
        </Link>
      </div>
