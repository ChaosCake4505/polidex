...
export default function NewYorkGovPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          ...
          <br />are the favorite to win the New York Governor’s Race.
        </h1>
        <p className="text-lg font-sans">
          <span className="text-[#3B82F6]">Democrats</span> have a{" "}
          <span className="text-[#3B82F6]">84%</span> Chance of Victory. Predicted Margin:{" "}
          <strong className="text-[#3B82F6]">Likely D</strong>
        </p>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="TBA"
          party="Democrat"
          percent={<span className="text-[#3B82F6]">54.5%</span>}
          image="/demlogo.png"
        />
        <div className="text-center text-gray-300">
          <p className="text-lg font-sans">Chance of Victory</p>
          <p className="text-2xl font-bold mt-1 text-[#3B82F6] font-sans">Democrats 80%</p>
        </div>
        <CandidateCard
          name="TBA"
          party="Republican"
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[380px] text-gray-300 text-lg">
          {/* Replace with <GovCountyMapNY /> if/when you build a county map */}
      ...
      <div className="text-center mb-12">
        ...
        >
          View New York Governor Primaries →
        </Link>
      </div>
