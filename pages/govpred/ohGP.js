...
export default function OhioGovPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        ...
        <p className="text-lg font-sans">
          <span className="text-[#ff5865]">Republicans</span> have a <span className="text-[#ff5865]">76%</span> Chance of Victory. Predicted Margin: <strong className="text-[#ff5865]">Likely R</strong>
        </p>
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * Ohio uses a semi-open primary system. Voters may choose a party's primary by requesting that party's ballot.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="TBA"
          party="Democrat"
          percent={<span className="text-blue-400">45.2%</span>}
          image="/demlogo.png"
        />
        <div className="text-center text-gray-300">
          <p className="text-lg font-sans">Chance of Victory</p>
          <p className="text-2xl font-bold mt-1 text-[#ff5865] font-sans">Republicans 76%</p>
        </div>
        <CandidateCard
          name="TBA"
          party="Republican"
          percent={<span className="text-[#ff5865]">52.1%</span>}
          image="/goplogo2.png"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[380px] text-gray-300 text-lg">
          {/* Replace with <GovCountyMapOH /> if/when you build a county map */}
