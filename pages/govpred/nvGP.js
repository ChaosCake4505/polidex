...
export default function NevadaGovPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex Forecasts that <span className="text-[#c26bf7]">Nevada</span>
          <br />is a Toss-Up in the Governor’s Race.
        </h1>
        <p className="text-lg font-sans">
          <span className="text-red-400">Republicans</span> have a{" "}
          <span className="text-red-400">57%</span> Chance of Victory. Predicted Margin:{" "}
          <strong className="text-[#c26bf7]">Toss-Up</strong>
        </p>
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * Nevada uses an open primary system. Voters may participate in any one party’s primary election, regardless of registration.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="TBA"
          party="Democrat"
          percent={<span className="text-blue-400">48.7%</span>}
          image="/demlogo.png"
        />
        <div className="text-center text-gray-300">
          <p className="text-lg font-sans">Chance of Victory</p>
          <p className="text-2xl font-bold mt-1 text-[#FF5865] font-sans">Republican 57%</p>
        </div>
        <CandidateCard
          name="Joe Lombardo"
          party="Republican"
          percent={<span className="text-[#FF5865]">50.5%</span>}
          image="/lombardo.jpg"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[380px] text-gray-300 text-lg">
          {/* Replace with <GovCountyMapNV /> when ready */}
      ...
      <div className="text-center mb-12">
        ...
        >
          View Nevada Governor Primaries →
        </Link>
      </div>
