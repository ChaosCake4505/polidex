...
export default function AlaskaGovPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        ...
        <p className="text-lg font-sans">
          ...
          <span className="text-[#FF5865]">80%</span> Chance of Victory. Predicted Margin:{" "}
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="TBA"
          party="Democrat"
          percent={<span className="text-blue-400">45.6%</span>}
          image="/demlogo.png"
        />
        <div className="text-center text-gray-300">
          <p className="text-lg font-sans">Chance of Victory</p>
          <p className="text-2xl font-bold mt-1 text-[#FF5865] font-sans">Republicans 80%</p>
        </div>
        <CandidateCard
          name="TBA"
          party="Republican"
          percent={<span className="text-[#FF5865]">52.8%</span>}
          image="/goplogo2.png"
        />
      </div>

      {/* County/Region Breakdown Placeholder */}
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        <h2 className="text-xl font-semibold mb-4 text-center">Regional Forecast</h2>
        <div className="w-full flex items-center justify-center min-h-[380px] text-gray-300 text-lg">
          {/* Replace with <GovRegionMapAK /> when ready */}
          Regional (borough/census area) forecast will appear here when available.
        </div>
      </div>
      ...
      <div className="text-center mb-12">
        ...
        >
          View Alaska Governor Primaries →
        </Link>
      </div>
