...
export default function HawaiiGovPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex Forecasts that <span className="text-blue-400">Josh Green</span>
          <br />is Favored to Win the Governor’s Race.
        </h1>
        ...
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * Hawaii uses a closed primary system. Voters must be registered party members to participate in their party’s primary.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="Josh Green"
          party="Democrat"
          percent={<span className="text-blue-400">61.4%</span>}
          image="/green.jpg"
        />
        ...
        <CandidateCard
          name="TBA"
          party="Republican"
          percent={<span className="text-[#FF5865]">35.2%</span>}
          image="/goplogo2.png"
        />
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[380px] text-gray-300 text-lg">
          {/* Replace with <GovCountyMapHI /> when ready */}
      ...
      <div className="text-center mb-12">
        ...
        >
          View Hawaii Governor Primaries →
        </Link>
      </div>
