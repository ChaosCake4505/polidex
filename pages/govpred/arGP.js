...
export default function ArkansasGovPredPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="bg-gray-800 py-10 px-6 text-center shadow-inner">
        <h1 className="text-4xl font-bold mb-4 leading-tight font-sans">
          Polidex Forecasts that <span className="text-[#ff5865]">Sarah Huckabee-Sanders</span>
          <br />is Favored in Arkansas’s Governor’s Race.
        </h1>
        ...
        <p className="text-sm text-gray-400 italic mt-2 font-sans">
          * Arkansas uses an open primary system. Voters may choose either party’s primary.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 my-12 px-4">
        <CandidateCard
          name="TBA"
          party="Democrat"
          percent={<span className="text-[#60a5fa]">41.2%</span>}
          image="/demlogo.png"
        />
        ...
        <CandidateCard
          name="Sara Huckabee-Sanders"
          party="Republican"
          percent={<span className="text-[#ff5865]">58.1%</span>}
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow max-w-6xl mx-auto my-12">
        ...
        <div className="w-full flex items-center justify-center min-h-[380px] text-gray-300 text-lg">
          {/* Replace with <GovCountyMapAR /> when ready */}
      ...
      <div className="text-center mb-12">
        ...
        >
          View Arkansas Governor Primaries →
        </Link>
      </div>
